...
x = np.array([[-2,-1],[-1,-2],[1,2],[2,1],[1,1],[-1,-1],[-2,1],[-1,2],[2,2]])
y = np.array([1,1,2,2,2,1,0,0,2])
# Ta sẽ cho một tập hợp X được dán nhãn theo giá trị (X < 0 <=> Y = 1) và ngược lại. Bạn có thể tùy biến miễn
# vẫn tuân theo một quy tắc nhất định.
...
# print(accu) để biết thêm chi tiết (Sẽ xuất kết quả = 1.0). Nếu có một tệp chứa dữ liệu, bạn nên sử dụng 75% để training
# và 25% còn lại để test độ chính xác
